...
},{"./chinese":"oqtX","./japanese":"YpTc","./combined":"C3Ht"}],"ln7H":[function(require,module,exports) {
"use strict";
...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    example.innerHTML = example.innerHTML.replace('{{japanese}}', _lyrics.japanese).replace('{{chinese}}', _lyrics.chinese).replace('{{combined}}', _lyrics.combined);
    var pre = document.createElement('pre');
    var code = document.createElement('code');
    code.className = 'language-html';
    code.textContent = example.innerHTML.trim().replaceAll('guoyunhe.me/wp-content/uploads/2015/03/hao-gan-win-win-wu-tiao-jian', 'example.com/audio');
    pre.append(code);
    example.append(pre);
  }
} catch (err) {
...
document.getElementById('chinese-input').addEventListener('change', function (e) {
  if (e.target.checked) {
    lyrics.setLyrics(_lyrics.chinese);
  }
});
document.getElementById('japanese-input').addEventListener('change', function (e) {
  if (e.target.checked) {
    lyrics.setLyrics(_lyrics.japanese);
  }
});
document.getElementById('combined-input').addEventListener('change', function (e) {
  if (e.target.checked) {
    lyrics.setLyrics(_lyrics.combined);
  }
});
...
//# sourceMappingURL=docs.e676ffc8.js.map