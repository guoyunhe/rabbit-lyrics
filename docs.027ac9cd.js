...
exports.default = _default;
},{}],"Qjx2":[function(require,module,exports) {
"use strict";
...
Object.defineProperty(exports, "karaoke", {
  enumerable: true,
  get: function () {
    return _karaoke.default;
  }
});
...
var _karaoke = _interopRequireDefault(require("./karaoke"));

var _romaji = _interopRequireDefault(require("./romaji"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
},{"./chinese":"oqtX","./combined":"C3Ht","./japanese":"YpTc","./karaoke":"Qjx2","./romaji":"WdFH"}],"ln7H":[function(require,module,exports) {
"use strict";
...
try {
  for (_iterator.s(); !(_step = _iterator.n()).done;) {
    ...
    example.innerHTML = example.innerHTML.replace('{{japanese}}', _lyrics.japanese).replace('{{chinese}}', _lyrics.chinese).replace('{{combined}}', _lyrics.combined).replace('{{karaoke}}', _lyrics.karaoke).replace('{{romaji}}', _lyrics.romaji);
...
//# sourceMappingURL=docs.027ac9cd.js.map